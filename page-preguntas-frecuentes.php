...
#rv-faq .hero::before{content:"";position:absolute;inset:-30px;opacity:.35;background-image:radial-gradient(rgba(212,175,55,.16) 1px,transparent 1px);background-size:26px 26px;-webkit-mask-image:radial-gradient(70% 60% at 50% 30%,#000,transparent);mask-image:radial-gradient(70% 60% at 50% 30%,#000,transparent);transform:translate(calc(var(--mx,0)*1px),calc(var(--my,0)*1px));transition:transform .25s ease-out}
#rv-faq .hero::after{content:"";position:absolute;left:50%;top:-140px;width:520px;height:520px;transform:translateX(-50%);background:radial-gradient(circle,rgba(212,175,55,.20),transparent 62%);filter:blur(8px);animation:rvfaqBreathe 7s ease-in-out infinite}
...
#rv-faq .rule{width:54px;height:2px;background:linear-gradient(90deg,transparent,#D4AF37,transparent);margin:0 auto 24px}
...
#rv-faq .search input:focus{border-color:#D4AF37;background:rgba(255,255,255,.12);box-shadow:0 0 0 4px rgba(212,175,55,.14)}
...
#rv-faq .cat{display:flex;align-items:center;gap:12px;font-weight:800;text-transform:uppercase;letter-spacing:.2em;font-size:.72rem;color:#D4AF37;margin:36px 0 14px}
#rv-faq .cat:first-child{margin-top:0}
#rv-faq .cat span{height:1px;flex:1;background:linear-gradient(90deg,rgba(212,175,55,.5),transparent)}
...
#rv-faq .item:target{border-color:#D4AF37;box-shadow:0 0 0 3px rgba(212,175,55,.18)}
#rv-faq .item{position:relative}
#rv-faq .item .q,#rv-faq .item .a-wrap{position:relative;z-index:2}
#rv-faq .item::after{content:"";position:absolute;inset:0;border-radius:16px;pointer-events:none;opacity:0;transition:opacity .35s ease;z-index:1;background:radial-gradient(260px circle at var(--gx,50%) var(--gy,50%),rgba(212,175,55,.16),transparent 46%)}
#rv-faq .item:hover::after{opacity:1}
#rv-faq .q{position:relative;cursor:pointer;padding:20px 22px;display:flex;align-items:center;gap:15px;font-weight:700;font-size:1.04rem;color:#000000;user-select:none}
.dark #rv-faq .q{color:#fff}
#rv-faq .q::before{content:"";position:absolute;left:0;top:14px;bottom:14px;width:3px;border-radius:0 3px 3px 0;background:#D4AF37;transform:scaleY(0);transform-origin:center;transition:transform .3s ease}
#rv-faq .item.open .q::before{transform:scaleY(1)}
#rv-faq .q .ico{flex:0 0 28px;width:28px;height:28px;border-radius:50%;background:#f4eedd;color:#D4AF37;display:flex;align-items:center;justify-content:center;transition:transform .35s cubic-bezier(.5,.2,.2,1),background .25s}
.dark #rv-faq .q .ico{background:#2a2413}
#rv-faq .q .ico svg{width:15px;height:15px}
#rv-faq .item.open .q .ico{transform:rotate(135deg);background:#D4AF37;color:#fff}
#rv-faq .q .txt{flex:1}
...
#rv-faq .pl:hover{color:#D4AF37;opacity:1}
...
#rv-faq .a a{color:#9a7b2e;font-weight:700;text-decoration:none;border-bottom:1px solid rgba(212,175,55,.45)}
.dark #rv-faq .a a{color:#D4B86A}
#rv-faq .a a:hover{border-bottom-color:#D4AF37}
#rv-faq .noresult{display:none;text-align:center;color:#64748b;padding:30px 0;font-size:.98rem}
#rv-faq .noresult a{color:#D4AF37;font-weight:700}
...
#rv-faq .cta::after{content:"";position:absolute;left:50%;bottom:-160px;width:460px;height:460px;transform:translateX(-50%);background:radial-gradient(circle,rgba(212,175,55,.16),transparent 62%)}
...
#rv-faq .btn{display:inline-flex;align-items:center;gap:9px;margin-top:26px;background:#D4AF37;color:#000000;font-weight:700;padding:14px 30px;border-radius:999px;text-decoration:none;transition:transform .25s,box-shadow .25s}
#rv-faq .btn:hover{transform:translateY(-2px);box-shadow:0 12px 26px rgba(212,175,55,.34)}
