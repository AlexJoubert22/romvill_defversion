...
var BQ_UI={
  es:{step:'Pregunta',of:'de',pct:'completado',next:'Siguiente',prev:'Anterior',optional:'Opcional',
      ...
      confirm:'Solicitud recibida',confirmTxt:'Hemos recibido su solicitud. En 24-48 horas laborables le enviaremos su presupuesto personalizado.',
      steps:['<strong>En 24-48 horas laborables</strong> revisamos su solicitud y preparamos su presupuesto.','<strong>Le enviamos su presupuesto</strong> personalizado por correo electrónico.','Si lo acepta, <strong>le enviamos el contrato</strong> y comenzamos el análisis.'],
  ...
  en:{step:'Question',of:'of',pct:'completed',next:'Next',prev:'Back',optional:'Optional',
      ...
      confirm:'Request received',confirmTxt:'We received your request. Within 24-48 working hours we will send you your personalised quote.',
      steps:['<strong>Within 24-48 working hours</strong> we review your request and prepare your quote.','<strong>We send your personalised quote</strong> by email.','If you accept, <strong>we send the contract</strong> and begin the analysis.'],
