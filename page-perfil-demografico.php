...
<main class="flex-grow">
    <section class="relative py-24 text-center px-6">
        <div class="max-w-3xl mx-auto">
            ...
            <span class="block text-xs font-bold text-secondary-ink dark:text-secondary uppercase tracking-[0.3em] mb-3"><?php echo esc_html( romvill_t( 'ana.dim' ) ); ?> 02</span>
            <h1 class="text-4xl md:text-6xl font-serif font-bold text-slate-900 dark:text-white mb-6"><?php echo esc_html( romvill_t( 'perfil.dem.h1' ) ); ?></h1>
    ...
    <?php romvill_perfil_viz( 'demografico' ); ?>

    <section class="max-w-5xl mx-auto px-6 pb-24">
        <div class="grid md:grid-cols-2 gap-8">
            <?php
            $cards = array(
                array('icon'=>'users','title'=>romvill_t('perfil.dem.c1.title'),'desc'=>romvill_t('perfil.dem.c1.desc')),
                array('icon'=>'home-family','title'=>romvill_t('perfil.dem.c2.title'),'desc'=>romvill_t('perfil.dem.c2.desc')),
                array('icon'=>'trending-up','title'=>romvill_t('perfil.dem.c3.title'),'desc'=>romvill_t('perfil.dem.c3.desc')),
                array('icon'=>'globe','title'=>romvill_t('perfil.dem.c4.title'),'desc'=>romvill_t('perfil.dem.c4.desc')),
            );
            foreach ($cards as $c) :
            ?>
