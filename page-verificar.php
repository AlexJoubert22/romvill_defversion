...
#rv-verif .hero::after{content:"";position:absolute;left:50%;top:-140px;width:520px;height:520px;transform:translateX(-50%);background:radial-gradient(circle,rgba(212,175,55,.18),transparent 62%);filter:blur(8px)}
...
#rv-verif .rule{width:54px;height:2px;background:linear-gradient(90deg,transparent,#D4AF37,transparent);margin:0 auto 24px}
...
#rv-verif input[type=text]{flex:1 1 260px;min-width:0;padding:14px 16px;border-radius:12px;border:1px solid #d6dae2;background:#fbfbfd;color:#000000;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:1rem;letter-spacing:.04em;text-transform:uppercase;outline:none;transition:.2s}
.dark #rv-verif input[type=text]{background:#0d1524;border-color:#243350;color:#fff}
#rv-verif input[type=text]:focus{border-color:#D4AF37;box-shadow:0 0 0 4px rgba(212,175,55,.15)}
#rv-verif button{flex:0 0 auto;background:#D4AF37;color:#000000;font-weight:700;border:0;border-radius:12px;padding:14px 26px;cursor:pointer;font-size:.98rem;transition:transform .2s,box-shadow .2s}
#rv-verif button:hover{transform:translateY(-1px);box-shadow:0 10px 22px rgba(212,175,55,.32)}
...
#rv-verif .ok{background:linear-gradient(160deg,#16203a,#0d1424);color:#fff;border:1px solid rgba(212,175,55,.45);padding:30px 28px;position:relative}
#rv-verif .ok .seal{position:absolute;top:24px;right:24px;width:64px;height:64px;color:#D4AF37;opacity:.95}
...
#rv-verif .ok dl{margin:22px 0 0;border-top:1px solid rgba(212,175,55,.3);padding-top:18px;display:grid;grid-template-columns:auto 1fr;gap:9px 22px;font-size:.96rem}
...
#rv-verif .ko a{display:inline-flex;align-items:center;gap:8px;margin-top:18px;background:#D4AF37;color:#000000;font-weight:700;padding:12px 24px;border-radius:999px;text-decoration:none;transition:transform .2s,box-shadow .2s}
#rv-verif .ko a:hover{transform:translateY(-1px);box-shadow:0 10px 22px rgba(212,175,55,.3)}
