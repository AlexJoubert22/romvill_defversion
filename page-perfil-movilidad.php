...
<main class="flex-grow">
    <section class="relative py-24 text-center px-6">
        <div class="max-w-3xl mx-auto">
            ...
            <span class="block text-xs font-bold text-secondary-ink dark:text-secondary uppercase tracking-[0.3em] mb-3"><?php echo esc_html( romvill_t( 'ana.dim' ) ); ?> 04</span>
    ...
    <?php romvill_perfil_viz( 'movilidad' ); ?>
    ...
    <?php romvill_related_dimensions( 'perfil-movilidad' ); ?>
</main>
