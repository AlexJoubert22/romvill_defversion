...
.rv-b1-logo-sub { font-size:11px; font-weight:600; letter-spacing:2px; color:var(--b1-text3); text-transform:uppercase; margin:6px 0 44px; }
...
.rv-b1-block-txt { font-size:11px; font-weight:700; letter-spacing:2px; color:var(--b1-accent); text-transform:uppercase; }
...
.rv-b1-mot-txt { font-size:11px; font-weight:700; letter-spacing:1.5px; color:var(--b1-accent); text-transform:uppercase; }
...
.rv-b1-q-opt-tag { display:inline-block; font-size:10px; font-weight:700; letter-spacing:1.5px; color:var(--b1-text3); text-transform:uppercase; border:1px solid var(--b1-border); border-radius:4px; padding:2px 7px; margin-left:8px; vertical-align:middle; }
...
.rv-b1-fl { display:block; font-size:11px; font-weight:700; letter-spacing:1px; color:var(--b1-text2); text-transform:uppercase; margin-bottom:10px; }
...
/* Estado del campo dibujado con CSS (no depende de la fuente de iconos) */
.rv-b1-fi-ic { position:absolute; right:0; bottom:12px; width:12px; height:12px; box-sizing:border-box; border:1.5px solid var(--b1-text3); border-radius:50%; background:transparent; pointer-events:none; transition:background .2s,border-color .2s; }
.rv-b1-fi-ic.ok { background:#B8862B; border-color:#B8862B; }
.rv-b1-fi-ic.ok::after { content:''; position:absolute; left:3px; top:0.5px; width:3px; height:6px; border:solid #fff; border-width:0 2px 2px 0; transform:rotate(45deg); }
...
.rv-b1-zona-lbl { font-size:10px; font-weight:700; letter-spacing:2px; color:var(--b1-text2); text-transform:uppercase; margin-bottom:8px; display:block; }
...
.rv-b1-pt-lbl { font-size:10px; font-weight:700; letter-spacing:3px; color:rgba(255,255,255,.4); text-transform:uppercase; margin-bottom:8px; }
...
.rv-b1-pt-intl { display:inline-block; background:var(--b1-accent); color:#fff; font-size:10px; font-weight:700; letter-spacing:2px; padding:3px 10px; text-transform:uppercase; border-radius:4px; margin-top:12px; }
...
.rv-b1-ptype-lbl { font-size:10px; font-weight:700; letter-spacing:3px; color:var(--b1-accent); text-transform:uppercase; margin-bottom:4px; }
...
.rv-b1-pc-lbl { font-size:10px; font-weight:700; letter-spacing:2px; color:var(--b1-text3); text-transform:uppercase; }
.rv-b1-btn-ed { display:inline-flex; align-items:center; gap:3px; background:none; border:1px solid var(--b1-border); padding:3px 9px; border-radius:6px; font-family:inherit; font-size:10px; font-weight:600; letter-spacing:1px; color:var(--b1-text2); text-transform:uppercase; cursor:pointer; transition:all .2s; }
...
.rv-b1-tag { display:inline-block; background:var(--b1-bg3); color:var(--b1-accent); font-size:10px; font-weight:700; letter-spacing:1px; padding:3px 9px; margin:2px; border-radius:4px; text-transform:uppercase; }
.rv-b1-ps-ttl { font-size:11px; font-weight:700; letter-spacing:2px; color:var(--b1-accent); text-transform:uppercase; margin:28px 0 6px; }
...
.rv-b1-sb { font-size:10px; font-weight:700; letter-spacing:2px; text-transform:uppercase; margin-bottom:4px; }
...
.rv-b1-consent { display:flex; gap:11px; align-items:flex-start; text-align:left; margin:0 auto 12px; max-width:520px; cursor:pointer; }
.rv-b1-consent input { flex:0 0 auto; width:17px; height:17px; margin-top:2px; accent-color:var(--b1-text); cursor:pointer; }
.rv-b1-consent span { font-size:13px; line-height:1.55; color:var(--b1-text); }
.rv-b1-consent a { color:var(--b1-text); font-weight:600; text-decoration:underline; }
.rv-b1-infobox { border:1px solid var(--b1-border); border-radius:10px; background:var(--b1-bg2); padding:12px 15px; font-size:11px; line-height:1.75; color:var(--b1-text2); text-align:left; margin:0 auto 24px; max-width:520px; }
.rv-b1-infobox b { color:var(--b1-text); }
.rv-b1-infobox .ttl { text-transform:uppercase; letter-spacing:.06em; }
.rv-b1-infobox a { color:var(--b1-text); font-weight:600; text-decoration:underline; }
.rv-b1-consent-err { display:none; color:var(--b1-err); font-size:12px; font-weight:600; margin-top:12px; }
...
.rv-b1-inv-lbl { display:block; font-size:10px; font-weight:700; letter-spacing:2px; text-transform:uppercase; color:var(--b1-text3); margin-bottom:6px; }
...
<div class="rv-b1-idle" id="rv-b1-idle">
    <p><strong id="rv-b1-idle-ttl">¿Sigue ahí?</strong> <span id="rv-b1-idle-txt">Sus respuestas están guardadas.</span></p>
    <button class="rv-b1-idle-btn" id="rv-b1-idle-btn" onclick="b1DismissIdle()">CONTINUAR</button>
</div>
...
<div class="rv-b1-screen active" id="rv-b1-sc-lang">
    <div class="rv-b1-lang-wrap">
        ...
        <div class="rv-b1-logo-sub" id="rv-b1-logo-sub">Análisis de Inteligencia Zonal · Solicitar Presupuesto</div>
    ...
    <div class="rv-b1-conf-wrap">
        ...
        <div class="rv-b1-conf-steps">
            <div class="rv-b1-conf-step">
                ...
                <div class="rv-b1-conf-stxt" id="rv-b1-cs1"><strong>En 24-48 horas laborables</strong> revisamos su solicitud y preparamos su presupuesto.</div>
            </div>
            <div class="rv-b1-conf-step">
        ...
        <div class="rv-b1-conf-tag" id="rv-b1-conf-tag">Su criterio antes de decidir, con cada dato verificado.</div>
...
var TR={
  es:{time:'Aproximadamente 4 minutos',btn:'EMPEZAMOS',
    ...
    cvp2:'Una vez más, gracias por confiar en nosotros.',cvp3:'Su criterio antes de decidir, con cada dato verificado.',
    ...
    confirmTxt:'Hemos recibido su solicitud. Recibirá un email de confirmación en los próximos minutos.',
    ...
    tag:'Su criterio antes de decidir, con cada dato verificado.',
    ...
    consent:'He leído y acepto la <a href="/privacidad" target="_blank">política de privacidad</a> y el tratamiento de mis respuestas para elaborar mi presupuesto y mi informe.',
    consentErr:'Debe aceptar la política de privacidad para continuar.',
    consentInfo:'<b class="ttl">Información básica sobre sus datos</b><br><b>Responsable:</b> ROMVILL &middot; <b>Finalidad:</b> elaborar su presupuesto y su informe — incluida la información personal que usted decida compartir, tratada con estricta confidencialidad<br><b>Destinatarios:</b> sus datos no se ceden a terceros &middot; <b>Sus derechos:</b> acceder, corregir o eliminar sus datos cuando lo desee, escribiendo a clients@romvill.com<br><b>Información adicional:</b> <a href="/privacidad" target="_blank">política de privacidad</a>',
    ...
    sendTitle:'¿Todo correcto?',sendSub:'Revise su perfil y si está conforme pulse el botón para enviarnos su solicitud. Recibirá un presupuesto personalizado en un plazo de 24-48 horas laborables.',
    ...
    questions:[
      ...
      {text:'¿Dispone de una dirección concreta?',note:'No es imprescindible: trabajaremos con la zona general que nos ha indicado.',type:'swf',opts:[{lbl:'Sí, tengo una dirección exacta',hasF:true,fph:'Calle, número, código postal, municipio'},{lbl:'No, me interesa la zona en general',hasF:false}],req:true},
      ...
      {text:'¿Cuál es su plazo estimado para recibir el análisis?',note:'El plazo que nos indique es determinante para elaborar un presupuesto adaptado a sus necesidades y garantizar la calidad del trabajo.',type:'single',opts:['Prioritario — nos volcamos en su análisis, entre 3 y 5 días laborables','Recomendado — la opción que eligen la mayoría, entre 7 y 10 días laborables','Con calma — cuidamos cada detalle, entre 12 y 15 días laborables','Aún estoy explorando'],req:true},
...
TR.pt.cvp1='Ao responder às perguntas seguintes ajudar-nos-á a conhecer o seu caso em detalhe e a elaborar um <strong>orçamento totalmente personalizado</strong>, adaptado exclusivamente às suas necessidades.';TR.pt.cvp2='Uma vez mais, obrigado por confiar em nós.';TR.pt.cvp3='O seu critério antes de decidir, com cada dado verificado.';TR.pt.cvdisc='<strong>A ROMVILL não vende imóveis, não cobra comissões e não tem qualquer interesse na sua decisão.</strong> Nós apenas analisamos — a decisão é sua. Os seus dados são tratados com total confidencialidade.';TR.pt.step='Pergunta';TR.pt.of='de';TR.pt.pct='concluído';TR.pt.optional='Opcional';TR.pt.editBtn='Editar';TR.pt.profile='Ver o meu perfil';TR.pt.midBtn='Ver o meu perfil';TR.pt.confirm='Pedido recebido';TR.pt.confirmTxt='Recebemos o seu pedido. Receberá um email de confirmação nos próximos minutos.';TR.pt.sendFail='Não foi possível enviar o seu pedido neste momento. As suas respostas foram guardadas. Por favor, tente novamente.';TR.pt.tag='O seu critério antes de decidir, com cada dado verificado.';TR.pt.sendTitle='Está tudo correto?';TR.pt.sendSub='Reveja o seu perfil e, se estiver tudo correto, prima o botão para nos enviar o seu pedido. Receberá um orçamento personalizado no prazo de 24-48 horas úteis.';TR.pt.legal='Ao enviar, aceita o tratamento dos seus dados conforme a nossa <a href="/privacidad" target="_blank">Política de Privacidade</a>.';TR.pt.consent='Li e aceito a <a href="/privacidad" target="_blank">política de privacidade</a> e o tratamento das minhas respostas para a elaboração do meu orçamento e do meu relatório.';TR.pt.consentErr='É necessário aceitar a política de privacidade para continuar.';TR.pt.consentInfo='<b class="ttl">Informação básica sobre os seus dados</b><br><b>Responsável pelo tratamento:</b> ROMVILL &middot; <b>Finalidade:</b> elaborar o seu orçamento e o seu relatório — incluindo a informação pessoal que decidir partilhar, tratada com estrita confidencialidade<br><b>Destinatários:</b> os seus dados não são comunicados a terceiros &middot; <b>Os seus direitos:</b> aceder, corrigir ou eliminar os seus dados sempre que o desejar, escrevendo para clients@romvill.com<br><b>Informação adicional:</b> <a href="/privacidad" target="_blank">política de privacidade</a>';TR.pt.midP1='Com os dados fornecidos, procederemos à elaboração do seu orçamento personalizado.';TR.pt.midP2='Uma vez recebido e aceite o orçamento, iniciaremos a sua Análise de Inteligência Zonal.';TR.pt.psTtl='Secções prioritárias do relatório';TR.pt.psSub='Calculadas automaticamente segundo o seu perfil';TR.pt.idleTtl='Ainda aí?';TR.pt.idleTxt='As suas respostas estão guardadas.';TR.pt.idleBtn='CONTINUAR';TR.pt.hdrTitle='Pedir orçamento';TR.pt.docType='Análise de Inteligência Zonal';TR.pt.locale='pt-PT';TR.pt.steps=['<strong>Pedido recebido</strong> — temos as suas respostas e o seu perfil.','<strong>Orçamento a caminho</strong> — preparamos o seu orçamento personalizado e enviamo-lo por email.','<strong>Relatório à medida</strong> — após a sua aceitação, iniciamos a sua Análise de Inteligência Zonal.'];
// ── EN: portada, cabecera de progreso, toast de inactividad y perfil ──
TR.en.cvp1='Answering the following questions will help us understand your case in detail and prepare a <strong>fully personalised quote</strong>, tailored exclusively to your needs.';
TR.en.cvp2='Once again, thank you for placing your trust in us.';
TR.en.cvp3='Your judgement before deciding, with every fact verified.';
TR.en.cvdisc='<strong>ROMVILL does not sell properties, charge commissions or have any interest in your decision.</strong> We only analyse — you decide. Your data is treated with complete confidentiality.';
TR.en.step='Question';TR.en.of='of';TR.en.pct='completed';
TR.en.psTtl='Priority report sections';TR.en.psSub='Calculated automatically from your profile and the information provided';
TR.en.idleTtl='Still there?';TR.en.idleTxt='Your answers are saved.';TR.en.idleBtn='CONTINUE';
TR.en.hdrTitle='Request a Quote';TR.en.docType='Area Intelligence Analysis';TR.en.locale='en-GB';
// ── FR: portada, cabecera de progreso, toast de inactividad y perfil ──
TR.fr.cvp1='En répondant aux questions suivantes, vous nous aiderez à connaître votre cas en détail et à élaborer un <strong>devis entièrement personnalisé</strong>, adapté exclusivement à vos besoins.';
TR.fr.cvp2='Encore une fois, merci de votre confiance.';
TR.fr.cvp3='Votre jugement avant de décider, chaque donnée vérifiée.';
TR.fr.cvdisc='<strong>ROMVILL ne vend pas de biens immobiliers, ne perçoit pas de commissions et n\'a aucun intérêt dans votre décision.</strong> Nous analysons seulement — vous décidez. Vos données sont traitées en toute confidentialité.';
TR.fr.step='Question';TR.fr.of='sur';TR.fr.pct='complété';
TR.fr.psTtl='Sections prioritaires du rapport';TR.fr.psSub='Calculées automatiquement selon votre profil et les informations fournies';
TR.fr.idleTtl='Toujours là ?';TR.fr.idleTxt='Vos réponses sont sauvegardées.';TR.fr.idleBtn='CONTINUER';
TR.fr.hdrTitle='Demander un devis';TR.fr.docType='Analyse d\'Intelligence Territoriale';TR.fr.locale='fr-FR';
TR.fr.confirm='Demande reçue';TR.fr.profile='Voir mon profil';TR.fr.midBtn='Voir mon profil';TR.fr.optional='Facultatif';TR.fr.editBtn='Modifier';TR.fr.tag='Votre jugement avant de décider, chaque donnée vérifiée.';
TR.fr.sendTitle='Tout est correct ?';TR.fr.sendSub='Vérifiez votre profil et, si tout vous convient, appuyez sur le bouton pour nous envoyer votre demande. Vous recevrez un devis personnalisé sous 24 à 48 heures ouvrées.';
TR.fr.legal='En envoyant votre demande, vous acceptez le traitement de vos données conformément à notre <a href="/privacidad" target="_blank">Politique de confidentialité</a>.';TR.fr.consent='J’ai lu et j’accepte la <a href="/privacidad" target="_blank">politique de confidentialité</a> ainsi que le traitement de mes réponses pour l’élaboration de mon devis et de mon rapport.';TR.fr.consentErr='Vous devez accepter la politique de confidentialité pour continuer.';TR.fr.consentInfo='<b class="ttl">Informations essentielles sur vos données</b><br><b>Responsable du traitement&nbsp;:</b> ROMVILL &middot; <b>Finalité&nbsp;:</b> élaborer votre devis et votre rapport — y compris les informations personnelles que vous choisissez de partager, traitées dans la plus stricte confidentialité<br><b>Destinataires&nbsp;:</b> vos données ne sont pas communiquées à des tiers &middot; <b>Vos droits&nbsp;:</b> accéder à vos données, les corriger ou les supprimer quand vous le souhaitez, en écrivant à clients@romvill.com<br><b>Informations complémentaires&nbsp;:</b> <a href="/privacidad" target="_blank">politique de confidentialité</a>';
// ── DE: portada, cabecera de progreso, toast de inactividad y perfil ──
TR.de.cvp1='Mit Ihren Antworten auf die folgenden Fragen lernen wir Ihren Fall im Detail kennen und erstellen ein <strong>vollständig persönliches Angebot</strong>, exakt auf Ihre Bedürfnisse zugeschnitten.';
TR.de.cvp2='Nochmals vielen Dank für Ihr Vertrauen.';
TR.de.cvp3='Klarheit, bevor Sie entscheiden — jede Angabe geprüft.';
TR.de.cvdisc='<strong>ROMVILL verkauft keine Immobilien, erhebt keine Provisionen und hat kein Interesse an Ihrer Entscheidung.</strong> Wir analysieren nur — Sie entscheiden. Ihre Daten werden streng vertraulich behandelt.';
TR.de.step='Frage';TR.de.of='von';TR.de.pct='erledigt';
TR.de.psTtl='Prioritäre Berichtsabschnitte';TR.de.psSub='Automatisch berechnet anhand Ihres Profils und der bereitgestellten Angaben';
TR.de.idleTtl='Sind Sie noch da?';TR.de.idleTxt='Ihre Antworten sind gespeichert.';TR.de.idleBtn='WEITER';
TR.de.hdrTitle='Angebot anfordern';TR.de.docType='Standort-Analyse';TR.de.locale='de-DE';
TR.de.confirm='Anfrage erhalten';TR.de.profile='Mein Profil anzeigen';TR.de.midBtn='Mein Profil ansehen';TR.de.optional='Optional';TR.de.editBtn='Bearbeiten';TR.de.tag='Klarheit, bevor Sie entscheiden — jede Angabe geprüft.';
TR.de.sendTitle='Alles korrekt?';TR.de.sendSub='Überprüfen Sie Ihr Profil und senden Sie uns Ihre Anfrage, wenn alles stimmt. Sie erhalten Ihr persönliches Angebot innerhalb von 24-48 Stunden an Werktagen.';
TR.de.legal='Mit dem Absenden akzeptieren Sie die Verarbeitung Ihrer Daten gemäß unserer <a href="/privacidad" target="_blank">Datenschutzerklärung</a>.';TR.de.consent='Ich habe die <a href="/privacidad" target="_blank">Datenschutzrichtlinie</a> gelesen und akzeptiere sie sowie die Verarbeitung meiner Antworten zur Erstellung meines Angebots und meines Berichts.';TR.de.consentErr='Sie müssen die Datenschutzrichtlinie akzeptieren, um fortzufahren.';TR.de.consentInfo='<b class="ttl">Grundlegende Informationen zu Ihren Daten</b><br><b>Verantwortlicher:</b> ROMVILL &middot; <b>Zweck:</b> Erstellung Ihres Angebots und Ihres Berichts – einschließlich der persönlichen Angaben, die Sie uns mitteilen möchten und die streng vertraulich behandelt werden<br><b>Empfänger:</b> Ihre Daten werden nicht an Dritte weitergegeben &middot; <b>Ihre Rechte:</b> Sie können Ihre Daten jederzeit einsehen sowie berichtigen oder löschen lassen – eine E-Mail an clients@romvill.com genügt<br><b>Weitere Informationen:</b> <a href="/privacidad" target="_blank">Datenschutzrichtlinie</a>';
// ── RU: portada, cabecera de progreso, toast de inactividad y perfil ──
TR.ru.cvp1='Ответы на следующие вопросы помогут нам детально изучить ваш случай и подготовить <strong>полностью персональное предложение</strong>, адаптированное исключительно под ваши потребности.';
TR.ru.cvp2='Ещё раз благодарим за доверие.';
TR.ru.cvp3='Ваше суждение перед решением — каждый факт проверен.';
TR.ru.cvdisc='<strong>ROMVILL не продаёт недвижимость, не взимает комиссий и не имеет никакого интереса в вашем решении.</strong> Мы только анализируем — решаете вы. Ваши данные обрабатываются строго конфиденциально.';
TR.ru.step='Вопрос';TR.ru.of='из';TR.ru.pct='выполнено';
TR.ru.psTtl='Приоритетные разделы отчёта';TR.ru.psSub='Рассчитано автоматически по вашему профилю';
TR.ru.idleTtl='Вы ещё здесь?';TR.ru.idleTxt='Ваши ответы сохранены.';TR.ru.idleBtn='ПРОДОЛЖИТЬ';
TR.ru.hdrTitle='Запрос предложения';TR.ru.docType='Анализ локации';TR.ru.locale='ru-RU';
TR.ru.confirm='Заявка получена';TR.ru.profile='Мой профиль';TR.ru.midBtn='Посмотреть мой профиль';TR.ru.optional='Необязательно';TR.ru.editBtn='Изменить';TR.ru.tag='Ваше суждение перед решением — каждый факт проверен.';
TR.ru.sendTitle='Всё верно?';TR.ru.sendSub='Проверьте ваш профиль и, если всё верно, нажмите кнопку, чтобы отправить нам заявку. Вы получите персональное предложение в течение 24–48 часов в рабочие дни.';
TR.ru.legal='Отправляя, вы соглашаетесь на обработку данных согласно нашей <a href="/privacidad" target="_blank">Политике конфиденциальности</a>.';TR.ru.consent='Я принимаю <a href="/privacidad" target="_blank">политику конфиденциальности</a> и даю согласие на обработку моих ответов для подготовки расчёта стоимости и отчёта.';TR.ru.consentErr='Вы должны принять политику конфиденциальности, чтобы продолжить.';TR.ru.consentInfo='<b class="ttl">Основная информация о ваших данных</b><br><b>Оператор данных:</b> ROMVILL &middot; <b>Цель обработки:</b> подготовка вашего расчёта стоимости и отчёта — включая личную информацию, которой вы сами решите поделиться и которая обрабатывается строго конфиденциально<br><b>Получатели данных:</b> ваши данные не передаются третьим лицам &middot; <b>Ваши права:</b> в любой момент получить доступ к своим данным, исправить или удалить их, написав нам на clients@romvill.com<br><b>Дополнительная информация:</b> <a href="/privacidad" target="_blank">политика конфиденциальности</a>';
// ── Traducciones de preguntas por idioma (Fase 2). El orden de opciones
// coincide EXACTAMENTE con TR.es (clave para el blindaje por índice).
TR.en.questions=[{"text":"What is your full name and nationality?","note":"We want to address you personally and tailor your analysis to your profile.","type":"cmp","req":true,"fields":[{"id":"nt","lbl":"Full name","type":"text","ph":"Name and surname","req":true},{"id":"nac","lbl":"Nationality","type":"sel","opts":["Select your nationality","Spanish","British","German","French","Dutch","Russian","Other"],"req":true}]},{"text":"Which city do you currently live in?","type":"text","ph":"Current city of residence","req":true},{"text":"What is your email address?","note":"Needed to send you your personalised quote and keep you informed throughout the process.","type":"text","ph":"email@example.com","req":true},{"text":"Contact number","note":"Your number will be used solely to contact you during the preparation of your analysis, should we need any specific clarification. Treated with complete confidentiality.","type":"tel","req":false,"optional":true},{"text":"In which language would you like to receive your analysis?","type":"single","opts":["Español","English","Deutsch","Français","Português","Русский"],"req":true},{"text":"Which area or city would you like us to analyse for you?","type":"zona","opts":["Marbella · Costa del Sol","Málaga","Alicante · Costa Blanca","Another area / Another country"],"req":true},{"text":"Do you have a specific address?","note":"If you don't have an exact address yet, don't worry — we'll work with the general area you've indicated.","type":"swf","req":true,"opts":[{"lbl":"Yes, I have an exact address","hasF":true,"fph":"Street, number, postal code, town"},{"lbl":"No, I'm interested in the area in general","hasF":false}]},{"text":"What do you need this analysis for?","type":"single","opts":["I want to understand an area better before making any decision","I'm considering settling or moving to this area","I'm looking for information about an area of personal or family interest","I'm considering a property investment or purchase","I need to analyse the area for a business or professional activity","I have a larger-scale project in this area","Another reason"],"req":true},{"text":"Is the analysis related to a specific property?","note":"If your enquiry concerns a specific property, let us know what type. If you're only interested in the area in general, select the last option.","type":"single","opts":["Flat or apartment","House or villa","Property to renovate","Plot to build on","Commercial premises","Industrial unit or warehouse","Business transfer","Entire building","Rural estate","Another type of property","Not a specific property, I'm interested in the area in general"],"req":true},{"text":"Will any minors be living in or regularly visiting the area?","note":"This lets us include schools, play areas and after-school activities in your report. We only need the approximate age ranges.","type":"multi","opts":["No minors","No minors currently, but I'd like to include this information","Yes — under 3 years","Yes — between 3 and 12","Yes — between 12 and 18"],"req":false,"optional":true},{"text":"Will there be any pets at the property?","note":"With this information we'll include veterinary clinics, pet-friendly parks and relevant services in the area.","type":"single","opts":["No pets","No pets currently, but I'd like to include this information","Yes, a dog","Yes, a cat","Yes, another pet"],"req":false,"optional":true},{"text":"Is there anyone with reduced mobility or special accessibility needs?","note":"This lets us include information on accessibility of the area, specialised centres and adapted transport.","type":"swf","req":false,"optional":true,"opts":[{"lbl":"No","hasF":false},{"lbl":"Yes","hasF":true,"fph":"Briefly tell us the type of need, whether for a minor or adult, and how many people"}]},{"text":"What is your estimated timeframe for receiving the analysis?","note":"The timeframe you indicate is key to preparing a quote suited to your needs and ensuring the quality of the work.","type":"single","opts":["Priority — we focus fully on your analysis, within 3 to 5 working days","Recommended — the option most clients choose, within 7 to 10 working days","No rush — we take care of every detail, within 12 to 15 working days","I'm still exploring"],"req":true},{"text":"How would you prefer to receive your quote?","type":"single","opts":["By email","By email, and I'd like a call to go over it"],"req":true},{"text":"How did you hear about us?","type":"single","opts":["Google search","Social media","Recommended by someone I trust","Other"],"req":false,"optional":true},{"text":"Is there anything else you consider important for us to know?","type":"textarea","ph":"Your additional comments...","req":false,"optional":true}];
TR.de.questions=[{"text":"Wie lautet Ihr vollständiger Name und Ihre Nationalität?","note":"Wir möchten Sie persönlich ansprechen und Ihre Analyse auf Ihr Profil abstimmen.","type":"cmp","req":true,"fields":[{"id":"nt","lbl":"Vollständiger Name","type":"text","ph":"Vor- und Nachname","req":true},{"id":"nac","lbl":"Nationalität","type":"sel","opts":["Wählen Sie Ihre Nationalität","Spanisch","Britisch","Deutsch","Französisch","Niederländisch","Russisch","Andere"],"req":true}]},{"text":"In welcher Stadt wohnen Sie derzeit?","type":"text","ph":"Aktueller Wohnort","req":true},{"text":"Wie lautet Ihre E-Mail-Adresse?","note":"Erforderlich, um Ihnen Ihr persönliches Angebot zu senden und Sie während des Prozesses zu informieren.","type":"text","ph":"email@example.com","req":true},{"text":"Telefonnummer","note":"Ihre Nummer wird ausschließlich verwendet, um Sie während der Erstellung Ihrer Analyse zu kontaktieren, falls wir eine konkrete Rückfrage haben. Streng vertraulich behandelt.","type":"tel","req":false,"optional":true},{"text":"In welcher Sprache möchten Sie Ihre Analyse erhalten?","type":"single","opts":["Español","English","Deutsch","Français","Português","Русский"],"req":true},{"text":"Welches Gebiet oder welche Stadt sollen wir für Sie analysieren?","type":"zona","opts":["Marbella · Costa del Sol","Málaga","Alicante · Costa Blanca","Anderes Gebiet / Anderes Land"],"req":true},{"text":"Haben Sie eine konkrete Adresse?","note":"Falls Sie noch keine genaue Adresse haben, kein Problem — wir arbeiten mit dem von Ihnen angegebenen Gebiet.","type":"swf","req":true,"opts":[{"lbl":"Ja, ich habe eine genaue Adresse","hasF":true,"fph":"Straße, Nummer, Postleitzahl, Ort"},{"lbl":"Nein, mich interessiert das Gebiet allgemein","hasF":false}]},{"text":"Wofür benötigen Sie diese Analyse?","type":"single","opts":["Ich möchte ein Gebiet besser verstehen, bevor ich eine Entscheidung treffe","Ich erwäge, mich in diesem Gebiet niederzulassen oder umzuziehen","Ich suche Informationen über ein Gebiet von persönlichem oder familiärem Interesse","Ich erwäge eine Immobilieninvestition oder einen Immobilienkauf","Ich muss das Gebiet für eine geschäftliche oder berufliche Tätigkeit analysieren","Ich habe ein größeres Projekt in diesem Gebiet","Anderer Grund"],"req":true},{"text":"Bezieht sich die Analyse auf eine konkrete Immobilie?","note":"Wenn sich Ihre Anfrage auf eine bestimmte Immobilie bezieht, teilen Sie uns deren Art mit. Wenn Sie nur das Gebiet allgemein interessiert, wählen Sie die letzte Option.","type":"single","opts":["Wohnung","Haus oder Villa","Sanierungsbedürftige Immobilie","Baugrundstück","Gewerberäume","Industriehalle oder Lager","Geschäftsübernahme","Gesamtes Gebäude","Landgut","Andere Art von Immobilie","Keine konkrete Immobilie, mich interessiert das Gebiet allgemein"],"req":true},{"text":"Werden Minderjährige in dem Gebiet wohnen oder es regelmäßig besuchen?","note":"So können wir Schulen, Spielplätze und außerschulische Aktivitäten in Ihren Bericht aufnehmen. Wir benötigen nur die ungefähren Altersgruppen.","type":"multi","opts":["Keine Minderjährigen","Derzeit keine Minderjährigen, aber ich möchte diese Information einbeziehen","Ja — unter 3 Jahren","Ja — zwischen 3 und 12","Ja — zwischen 12 und 18"],"req":false,"optional":true},{"text":"Werden Haustiere in der Immobilie leben?","note":"Mit dieser Information nehmen wir Tierkliniken, Hundewiesen und relevante Dienstleistungen im Gebiet auf.","type":"single","opts":["Keine Haustiere","Derzeit keine Haustiere, aber ich möchte diese Information einbeziehen","Ja, ein Hund","Ja, eine Katze","Ja, ein anderes Haustier"],"req":false,"optional":true},{"text":"Gibt es eine Person mit eingeschränkter Mobilität oder besonderem Bedarf an Barrierefreiheit?","note":"So können wir Informationen zur Barrierefreiheit des Umfelds, zu spezialisierten Zentren und zum barrierefreien Nahverkehr aufnehmen.","type":"swf","req":false,"optional":true,"opts":[{"lbl":"Nein","hasF":false},{"lbl":"Ja","hasF":true,"fph":"Beschreiben Sie kurz die Art des Bedarfs, ob für eine minderjährige oder erwachsene Person, und für wie viele Personen"}]},{"text":"Wann benötigen Sie die Analyse voraussichtlich?","note":"Der von Ihnen angegebene Zeitrahmen ist entscheidend, um ein auf Ihre Bedürfnisse abgestimmtes Angebot zu erstellen und die Qualität der Arbeit zu gewährleisten.","type":"single","opts":["Vorrangig — wir widmen uns voll Ihrer Analyse, innerhalb von 3 bis 5 Werktagen","Empfohlen — die Option, die die meisten wählen, innerhalb von 7 bis 10 Werktagen","Ohne Eile — wir kümmern uns um jedes Detail, innerhalb von 12 bis 15 Werktagen","Ich orientiere mich noch"],"req":true},{"text":"Wie möchten Sie Ihr Angebot erhalten?","type":"single","opts":["Per E-Mail","Per E-Mail, und ich hätte gern einen Anruf zur Klärung"],"req":true},{"text":"Wie haben Sie von uns erfahren?","type":"single","opts":["Google-Suche","Soziale Medien","Empfehlung einer Vertrauensperson","Sonstiges"],"req":false,"optional":true},{"text":"Gibt es noch etwas, das wir Ihrer Meinung nach wissen sollten?","type":"textarea","ph":"Ihre zusätzlichen Anmerkungen...","req":false,"optional":true}];
TR.fr.questions=[{"text":"Quel est votre nom complet et votre nationalité ?","note":"Nous souhaitons nous adresser à vous personnellement et adapter votre analyse à votre profil.","type":"cmp","req":true,"fields":[{"id":"nt","lbl":"Nom complet","type":"text","ph":"Nom et prénom","req":true},{"id":"nac","lbl":"Nationalité","type":"sel","opts":["Sélectionnez votre nationalité","Espagnole","Britannique","Allemande","Française","Néerlandaise","Russe","Autre"],"req":true}]},{"text":"Dans quelle ville résidez-vous actuellement ?","type":"text","ph":"Ville de résidence actuelle","req":true},{"text":"Quelle est votre adresse e-mail ?","note":"Nécessaire pour vous envoyer votre devis personnalisé et vous tenir informé tout au long du processus.","type":"text","ph":"email@example.com","req":true},{"text":"Numéro de contact","note":"Votre numéro sera utilisé uniquement pour vous contacter pendant l'élaboration de votre analyse, en cas de précision ponctuelle nécessaire. Traité en toute confidentialité.","type":"tel","req":false,"optional":true},{"text":"Dans quelle langue souhaitez-vous recevoir votre analyse ?","type":"single","opts":["Español","English","Deutsch","Français","Português","Русский"],"req":true},{"text":"Quelle zone ou ville souhaitez-vous que nous analysions pour vous ?","type":"zona","opts":["Marbella · Costa del Sol","Málaga","Alicante · Costa Blanca","Autre zone / Autre pays"],"req":true},{"text":"Disposez-vous d'une adresse précise ?","note":"Si vous n'avez pas encore d'adresse exacte, ne vous inquiétez pas — nous travaillerons avec la zone générale que vous nous avez indiquée.","type":"swf","req":true,"opts":[{"lbl":"Oui, j'ai une adresse exacte","hasF":true,"fph":"Rue, numéro, code postal, commune"},{"lbl":"Non, la zone en général m'intéresse","hasF":false}]},{"text":"Dans quel but avez-vous besoin de cette analyse ?","type":"single","opts":["Je veux mieux comprendre une zone avant de prendre une décision","J'envisage de m'installer ou de déménager dans cette zone","Je cherche des informations sur une zone d'intérêt personnel ou familial","J'envisage un investissement ou un achat immobilier","J'ai besoin d'analyser la zone pour une activité commerciale ou professionnelle","J'ai un projet de plus grande envergure dans cette zone","Autre raison"],"req":true},{"text":"L'analyse concerne-t-elle un bien immobilier précis ?","note":"Si votre demande concerne un bien précis, indiquez-nous son type. Si seule la zone en général vous intéresse, sélectionnez la dernière option.","type":"single","opts":["Appartement","Maison ou villa","Bien à rénover","Terrain à bâtir","Local commercial","Local industriel ou entrepôt","Cession de fonds de commerce","Immeuble entier","Domaine rural","Autre type de bien","Pas un bien précis, la zone en général m'intéresse"],"req":true},{"text":"Des mineurs vont-ils résider dans la zone ou la fréquenter régulièrement ?","note":"Cela nous permet d'inclure les établissements scolaires, aires de jeux et activités périscolaires dans votre rapport. Nous avons seulement besoin des tranches d'âge approximatives.","type":"multi","opts":["Aucun mineur","Aucun mineur actuellement, mais je souhaite inclure cette information","Oui — moins de 3 ans","Oui — entre 3 et 12 ans","Oui — entre 12 et 18 ans"],"req":false,"optional":true},{"text":"Y aura-t-il des animaux de compagnie dans le logement ?","note":"Avec cette information, nous inclurons les cliniques vétérinaires, les parcs adaptés aux animaux et les services pertinents de la zone.","type":"single","opts":["Aucun animal","Aucun animal actuellement, mais je souhaite inclure cette information","Oui, un chien","Oui, un chat","Oui, un autre animal"],"req":false,"optional":true},{"text":"Y a-t-il une personne à mobilité réduite ou ayant un besoin particulier d'accessibilité ?","note":"Cela nous permet d'inclure des informations sur l'accessibilité de l'environnement, les centres spécialisés et les transports adaptés.","type":"swf","req":false,"optional":true,"opts":[{"lbl":"Non","hasF":false},{"lbl":"Oui","hasF":true,"fph":"Indiquez brièvement le type de besoin, s'il s'agit d'un mineur ou d'un adulte, et combien de personnes"}]},{"text":"Quel est votre délai estimé pour recevoir l'analyse ?","note":"Le délai que vous indiquez est déterminant pour élaborer un devis adapté à vos besoins et garantir la qualité du travail.","type":"single","opts":["Prioritaire — nous nous consacrons pleinement à votre analyse, sous 3 à 5 jours ouvrés","Recommandé — l'option que choisissent la plupart, sous 7 à 10 jours ouvrés","Sans hâte — nous soignons chaque détail, sous 12 à 15 jours ouvrés","Je me renseigne encore"],"req":true},{"text":"Comment préférez-vous recevoir votre devis ?","type":"single","opts":["Par e-mail","Par e-mail, et je souhaiterais un appel pour en discuter"],"req":true},{"text":"Comment avez-vous connu nos services ?","type":"single","opts":["Recherche Google","Réseaux sociaux","Recommandé par une personne de confiance","Autre"],"req":false,"optional":true},{"text":"Y a-t-il autre chose que vous jugez important de nous communiquer ?","type":"textarea","ph":"Vos commentaires supplémentaires...","req":false,"optional":true}];
TR.pt.questions=[{"text":"Qual é o seu nome completo e a sua nacionalidade?","note":"Queremos dirigir-nos a si de forma personalizada e adaptar melhor a sua análise ao seu perfil.","type":"cmp","req":true,"fields":[{"id":"nt","lbl":"Nome completo","type":"text","ph":"Nome e apelidos","req":true},{"id":"nac","lbl":"Nacionalidade","type":"sel","opts":["Selecione a sua nacionalidade","Espanhola","Britânica","Alemã","Francesa","Neerlandesa","Russa","Outra"],"req":true}]},{"text":"Em que cidade reside atualmente?","type":"text","ph":"Cidade de residência atual","req":true},{"text":"Qual é o seu correio eletrónico?","note":"Necessário para lhe enviarmos o seu orçamento personalizado e o mantermos informado durante o processo.","type":"text","ph":"email@example.com","req":true},{"text":"Número de contacto","note":"O seu número será utilizado exclusivamente para o contactar durante a elaboração da sua análise, caso seja necessário algum esclarecimento pontual. Tratado com total confidencialidade.","type":"tel","req":false,"optional":true},{"text":"Em que idioma deseja receber a sua análise?","type":"single","opts":["Español","English","Deutsch","Français","Português","Русский"],"req":true},{"text":"Que zona ou cidade deseja que analisemos para si?","type":"zona","opts":["Marbella · Costa del Sol","Málaga","Alicante · Costa Blanca","Outra zona / Outro país"],"req":true},{"text":"Dispõe de uma morada concreta?","note":"Se ainda não tem uma morada exata, não se preocupe — trabalharemos com a zona geral que nos indicou.","type":"swf","req":true,"opts":[{"lbl":"Sim, tenho uma morada exata","hasF":true,"fph":"Rua, número, código postal, localidade"},{"lbl":"Não, interessa-me a zona em geral","hasF":false}]},{"text":"Para que necessita desta análise?","type":"single","opts":["Quero conhecer melhor uma zona antes de tomar qualquer decisão","Estou a ponderar instalar-me ou mudar-me para esta zona","Procuro informação sobre uma zona de interesse pessoal ou familiar","Estou a considerar um investimento ou aquisição imobiliária","Preciso de analisar a zona para uma atividade empresarial ou profissional","Tenho um projeto de maior dimensão nesta zona","Outro motivo"],"req":true},{"text":"A análise está relacionada com um imóvel concreto?","note":"Se a sua consulta diz respeito a um imóvel específico, indique-nos o tipo. Se apenas lhe interessa a zona em geral, selecione a última opção.","type":"single","opts":["Apartamento","Moradia ou vivenda","Imóvel para remodelar","Terreno para construir","Espaço comercial","Pavilhão industrial ou armazém","Trespasse de negócio","Edifício completo","Quinta rústica","Outro tipo de imóvel","Não é um imóvel concreto, interessa-me a zona em geral"],"req":true},{"text":"Haverá menores que vão residir ou frequentar regularmente a zona?","note":"Conhecer este dado permite-nos incluir escolas, parques infantis e atividades extracurriculares no seu relatório. Apenas precisamos das faixas etárias aproximadas.","type":"multi","opts":["Não há menores","Não há menores atualmente, mas desejo incluir esta informação","Sim — menores de 3 anos","Sim — entre 3 e 12 anos","Sim — entre 12 e 18 anos"],"req":false,"optional":true},{"text":"Haverá animais de companhia no imóvel?","note":"Com esta informação incluiremos clínicas veterinárias, parques para animais e serviços relevantes na zona.","type":"single","opts":["Não há animais","Não há animais atualmente, mas desejo incluir esta informação","Sim, cão","Sim, gato","Sim, outro animal de companhia"],"req":false,"optional":true},{"text":"Existe alguma pessoa com mobilidade reduzida ou necessidade especial de acessibilidade?","note":"Esta informação permite-nos incluir dados sobre acessibilidade da envolvente, centros especializados e transporte adaptado.","type":"swf","req":false,"optional":true,"opts":[{"lbl":"Não","hasF":false},{"lbl":"Sim","hasF":true,"fph":"Indique brevemente o tipo de necessidade, se é para um menor ou adulto e quantas pessoas"}]},{"text":"Qual é o seu prazo estimado para receber a análise?","note":"O prazo que nos indicar é determinante para elaborar um orçamento adaptado às suas necessidades e garantir a qualidade do trabalho.","type":"single","opts":["Prioritário — dedicamo-nos por inteiro à sua análise, entre 3 e 5 dias úteis","Recomendado — a opção que a maioria escolhe, entre 7 e 10 dias úteis","Sem pressa — cuidamos de cada detalhe, entre 12 e 15 dias úteis","Ainda estou a explorar"],"req":true},{"text":"Como prefere receber o seu orçamento?","type":"single","opts":["Por correio eletrónico","Por correio eletrónico, e gostaria de uma chamada para o esclarecer"],"req":true},{"text":"Como nos conheceu?","type":"single","opts":["Pesquisa no Google","Redes sociais","Recomendado por alguém de confiança","Outro"],"req":false,"optional":true},{"text":"Há mais alguma coisa que considere importante que saibamos?","type":"textarea","ph":"Os seus comentários adicionais...","req":false,"optional":true}];
TR.ru.questions=[{"text":"Как вас зовут (полное имя) и какое у вас гражданство?","note":"Мы хотим обращаться к вам лично и лучше адаптировать анализ под ваш профиль.","type":"cmp","req":true,"fields":[{"id":"nt","lbl":"Полное имя","type":"text","ph":"Имя и фамилия","req":true},{"id":"nac","lbl":"Гражданство","type":"sel","opts":["Выберите ваше гражданство","Испанское","Британское","Немецкое","Французское","Нидерландское","Российское","Другое"],"req":true}]},{"text":"В каком городе вы сейчас проживаете?","type":"text","ph":"Текущий город проживания","req":true},{"text":"Укажите вашу электронную почту.","note":"Необходима, чтобы отправить вам персональное предложение и информировать вас в ходе процесса.","type":"text","ph":"email@example.com","req":true},{"text":"Контактный номер","note":"Ваш номер будет использован исключительно для связи с вами во время подготовки анализа, если потребуется уточнение. Полная конфиденциальность.","type":"tel","req":false,"optional":true},{"text":"На каком языке вы хотите получить анализ?","type":"single","opts":["Español","English","Deutsch","Français","Português","Русский"],"req":true},{"text":"Какой район или город вы хотите, чтобы мы проанализировали?","type":"zona","opts":["Marbella · Costa del Sol","Málaga","Alicante · Costa Blanca","Другой район / Другая страна"],"req":true},{"text":"У вас есть конкретный адрес?","note":"Если точного адреса пока нет, не беспокойтесь — мы будем работать с указанным вами районом в целом.","type":"swf","req":true,"opts":[{"lbl":"Да, у меня есть точный адрес","hasF":true,"fph":"Улица, номер, почтовый индекс, населённый пункт"},{"lbl":"Нет, меня интересует район в целом","hasF":false}]},{"text":"Для чего вам нужен этот анализ?","type":"single","opts":["Хочу лучше понять район, прежде чем принимать решение","Рассматриваю переезд или обустройство в этом районе","Ищу информацию о районе, интересном лично мне или моей семье","Рассматриваю инвестицию или покупку недвижимости","Мне нужно проанализировать район для коммерческой или профессиональной деятельности","У меня есть более масштабный проект в этом районе","Другая причина"],"req":true},{"text":"Связан ли анализ с конкретным объектом недвижимости?","note":"Если ваш запрос касается конкретного объекта, укажите его тип. Если вас интересует только район в целом, выберите последний вариант.","type":"single","opts":["Квартира","Дом или вилла","Объект под ремонт","Участок под застройку","Коммерческое помещение","Промышленное помещение или склад","Готовый бизнес (переуступка)","Здание целиком","Загородное поместье","Другой тип недвижимости","Не конкретный объект, меня интересует район в целом"],"req":true},{"text":"Будут ли в районе проживать или регулярно бывать несовершеннолетние?","note":"Это позволит включить в отчёт школы, игровые зоны и внешкольные занятия. Нам нужны только примерные возрастные группы.","type":"multi","opts":["Несовершеннолетних нет","Сейчас нет, но я хочу включить эту информацию","Да — до 3 лет","Да — от 3 до 12 лет","Да — от 12 до 18 лет"],"req":false,"optional":true},{"text":"Будут ли в жилье домашние животные?","note":"С этой информацией мы включим ветеринарные клиники, парки для животных и соответствующие услуги в районе.","type":"single","opts":["Животных нет","Сейчас нет, но я хочу включить эту информацию","Да, собака","Да, кошка","Да, другое животное"],"req":false,"optional":true},{"text":"Есть ли человек с ограниченной подвижностью или особыми потребностями в доступности?","note":"Это позволит включить информацию о доступности среды, специализированных центрах и адаптированном транспорте.","type":"swf","req":false,"optional":true,"opts":[{"lbl":"Нет","hasF":false},{"lbl":"Да","hasF":true,"fph":"Кратко укажите тип потребности, для несовершеннолетнего или взрослого, и сколько человек"}]},{"text":"В какой срок вы предполагаете получить анализ?","note":"Указанный вами срок определяет подготовку предложения под ваши потребности и обеспечение качества работы.","type":"single","opts":["Приоритетно — мы полностью посвящаем себя вашему анализу, в течение 3–5 рабочих дней","Рекомендуется — вариант, который выбирает большинство, в течение 7–10 рабочих дней","Без спешки — мы заботимся о каждой детали, в течение 12–15 рабочих дней","Я пока изучаю варианты"],"req":true},{"text":"Как вы предпочитаете получить предложение?","type":"single","opts":["По электронной почте","По электронной почте, плюс звонок для обсуждения деталей"],"req":true},{"text":"Как вы о нас узнали?","type":"single","opts":["Поиск в Google","Социальные сети","По рекомендации доверенного лица","Другое"],"req":false,"optional":true},{"text":"Есть ли что-то ещё важное, что нам следует знать?","type":"textarea","ph":"Ваши дополнительные комментарии...","req":false,"optional":true}];

TR.en.btn='LET\'S START';TR.en.next='Next';TR.en.prev='Back';TR.en.send='REQUEST QUOTE';TR.en.sending='SENDING...';TR.en.confirm='Request received';TR.en.profile='View my profile';TR.en.optional='Optional';TR.en.editBtn='Edit';TR.en.errMsg='Please answer this question before continuing.';TR.en.errSend='We couldn\'t send your request. Please try again.';TR.en.sendFail='We could not send your request right now. Your answers have been saved. Please try again.';TR.en.retry='Retry submission';TR.en.intlBadge='INTERNATIONAL CLIENT';TR.en.midTitle='Thank you for completing the questionnaire.';TR.en.midP1='With the information provided, we will proceed to prepare your personalised quote.';TR.en.midP2='Once received and accepted, we will begin your Area Intelligence Analysis.';TR.en.midBtn='View my profile';TR.en.sendTitle='Is everything correct?';TR.en.sendSub='Review your profile and, if everything is correct, press the button to send us your request.';TR.en.legal='By submitting you accept our <a href="/privacidad" target="_blank">Privacy Policy</a>.';TR.en.consent='I have read and accept the <a href="/privacidad" target="_blank">privacy policy</a> and agree to the processing of my answers to prepare my quote and report.';TR.en.consentErr='You must accept the privacy policy to continue.';TR.en.consentInfo='<b class="ttl">Basic information about your data</b><br><b>Data controller:</b> ROMVILL &middot; <b>Purpose:</b> to prepare your quote and report – including any personal information you choose to share, which is treated in the strictest confidence<br><b>Recipients:</b> your data is not shared with third parties &middot; <b>Your rights:</b> access, correct or delete your data whenever you wish by writing to clients@romvill.com<br><b>Further information:</b> <a href="/privacidad" target="_blank">privacy policy</a>';TR.en.time='Approximately 4 minutes';TR.en.confirmTxt='We have received your request. You will receive a confirmation email within the next few minutes.';TR.en.tag='Your judgement before deciding, with every fact verified.';TR.en.steps=['<strong>Request received</strong> — we have your answers and your profile.','<strong>Quote on its way</strong> — we prepare your personalised quote and send it by email.','<strong>Tailored report</strong> — once you accept, we begin your Area Intelligence Analysis.'];
TR.de.confirmTxt='Wir haben Ihre Anfrage erhalten. Sie erhalten in den nächsten Minuten eine Bestätigungs-E-Mail.';TR.de.steps=['<strong>Anfrage erhalten</strong> — wir haben Ihre Antworten und Ihr Profil.','<strong>Angebot unterwegs</strong> — wir erstellen Ihr persönliches Angebot und senden es per E-Mail.','<strong>Maßgeschneiderter Bericht</strong> — nach Ihrer Annahme beginnen wir Ihre Standort-Analyse.'];
TR.fr.confirmTxt='Nous avons reçu votre demande. Vous recevrez un e-mail de confirmation dans les prochaines minutes.';TR.fr.steps=['<strong>Demande reçue</strong> — nous avons vos réponses et votre profil.','<strong>Devis en préparation</strong> — nous préparons votre devis personnalisé et vous l\'envoyons par e-mail.','<strong>Rapport sur mesure</strong> — dès votre acceptation, nous commençons votre Analyse d\'Intelligence Territoriale.'];
TR.pt.confirmTxt='Recebemos o seu pedido. Receberá um email de confirmação nos próximos minutos.';TR.pt.steps=['<strong>Pedido recebido</strong> — temos as suas respostas e o seu perfil.','<strong>Orçamento a caminho</strong> — preparamos o seu orçamento personalizado e enviamo-lo por email.','<strong>Relatório à medida</strong> — após a sua aceitação, iniciamos a sua Análise de Inteligência Zonal.'];
TR.ru.confirmTxt='Мы получили вашу заявку. В ближайшие минуты вы получите письмо с подтверждением.';TR.ru.steps=['<strong>Заявка получена</strong> — у нас есть ваши ответы и профиль.','<strong>Предложение готовится</strong> — мы подготовим персональное предложение и отправим его на email.','<strong>Индивидуальный отчёт</strong> — после принятия предложения мы начнём ваш Анализ локации.'];TR.en.secLabels={hi:'PRIORITY',md:'RELEVANT',lo:'STANDARD'};TR.en.motivators={6:{txt:'AREA OF INTEREST REGISTERED',sub:'We already have what we need'},10:{txt:'FINAL STRETCH',sub:'Just a few more questions'},13:{txt:'ALMOST DONE',sub:'We are preparing your profile'}};TR.en.agentTitle='I would like personalised assistance from an analyst';TR.en.agentSub='If you select this option, an analyst will contact you as soon as possible.';TR.en.blocks={1:'About you',6:'Your area of interest',8:'Your enquiry',10:'To personalise your report',13:'Your timeline'};
...
function b1RenderQ(){
  ...
  // Text
    ...
    h+='<div class="rv-b1-fg">'
      +'<input class="rv-b1-fi'+(v?' valid':'')+'" id="rv-b1-fi-main" type="'+(cQ===2?'email':'text')+'" value="'+v+'" placeholder="'+(q.ph||'')+'" oninput="b1OnFI(this,\''+key+'\')"><span aria-hidden="true" class="rv-b1-fi-ic'+(v?' ok':'')+'" id="rv-b1-fic-main"></span>'
      +'</div>';
    ...
    q.fields.forEach(function(f){
      ...
      if(f.type==='text'){
        h+='<input class="rv-b1-fi'+(v?' valid':'')+'" id="rv-b1-fi-'+f.id+'" type="text" value="'+v+'" placeholder="'+(f.ph||'')+'" oninput="b1OnFI(this,\''+f.id+'\')">'
          +'<span aria-hidden="true" class="rv-b1-fi-ic'+(v?' ok':'')+'" id="rv-b1-fic-'+f.id+'"></span>';
      }else if(f.type==='sel'){
...
function b1OnFI(el,key){var v=el.value.trim();A[key]=v;b1Save();el.classList.toggle('valid',!!v);var ic=document.getElementById('rv-b1-fic-'+el.id.replace('rv-b1-fi-',''));if(ic){ic.classList.toggle('ok',!!v);}}
...
function b1RenderProfile(){
  ...
  var fecha=new Date().toLocaleDateString((T.locale||'es-ES'),{day:'numeric',month:'long',year:'numeric'});
  ...
  document.getElementById('rv-b1-pc').innerHTML=
    ...
    +'<div class="rv-b1-send-box">'
      ...
      +'<label class="rv-b1-consent"><input type="checkbox" id="rv-b1-ck" onchange="b1Ck(this)"><span>'+(T.consent||TR.es.consent)+'</span></label>'
      +'<div class="rv-b1-infobox">'+(T.consentInfo||TR.es.consentInfo)+'</div>'
      ...
      +'<div class="rv-b1-inv">'
        ...
        +'</div>'
      +'</div>'
      +'<div class="rv-b1-consent-err" id="rv-b1-ckerr">'+(T.consentErr||TR.es.consentErr)+'</div>'
    +'</div>';
...
function b1Ck(el){
  var e=document.getElementById('rv-b1-ckerr');
  if(e&&el.checked)e.style.display='none';
}

function b1SendProfile(ref){
  var ck=document.getElementById('rv-b1-ck');
  if(ck&&!ck.checked){
    var ce=document.getElementById('rv-b1-ckerr');
  ...
  var payload=Object.assign({},A,{ref:ref,lang:lang,claves:b1Claves(),rgpd:'1'});
...
if(lang!=='es'){
  T=TR[lang]||TR.es;
  if(document.getElementById('rv-b1-hs'))b1ApplyStatic();
