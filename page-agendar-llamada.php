...
.rv-ag-head { background:#101622; text-align:center; padding:26px 18px 20px; }
...
.rv-ag h1 { font-family:Georgia,serif; font-size:23px; color:#101622; margin:0 0 6px; font-weight:700; line-height:1.3; }
.rv-ag-sub { font-size:14.5px; color:#5c6b80; margin:0 0 18px; line-height:1.6; }
.rv-ag-exp { display:inline-block; background:#101622; color:#fff; font-size:12px; font-weight:800; letter-spacing:1px; padding:5px 12px; border-radius:999px; margin-bottom:20px; text-transform:uppercase; }
...
.rv-ag-dia .dnum { font-size:20px; font-weight:800; color:#101622; margin:2px 0; }
.rv-ag-dia .dmes { font-size:11px; color:#8a919c; }
.rv-ag-dia.sel { border-color:#101622; background:#101622; }
...
.rv-ag-hora { border:1.5px solid #e4e1d8; background:#fff; border-radius:10px; padding:11px 0; text-align:center; font-size:15px; font-weight:700; color:#101622; cursor:pointer; }
.rv-ag-hora.sel { background:#101622; color:#C9A653; border-color:#101622; }
.rv-ag-hora.off { opacity:.35; text-decoration:line-through; cursor:default; }
.rv-ag input[type=text], .rv-ag input[type=tel], .rv-ag textarea { width:100%; border:1.5px solid #e4e1d8; border-radius:10px; padding:13px 14px; font-size:16px; font-family:inherit; background:#fff; color:#101622; outline:none; }
.rv-ag input:focus, .rv-ag textarea:focus { border-color:#101622; }
.rv-ag textarea { min-height:96px; resize:vertical; }
.rv-ag-btn { display:block; width:100%; background:#101622; color:#fff; border:0; border-radius:10px; padding:16px; font-size:16px; font-weight:800; letter-spacing:.5px; margin-top:20px; font-family:inherit; cursor:pointer; }
...
.rv-ag-card .cbig { font-size:19px; font-weight:800; color:#101622; line-height:1.4; }
.rv-ag-card .csub { font-size:13.5px; color:#5c6b80; margin-top:4px; line-height:1.6; }
.rv-ag-link { display:inline-block; margin-top:12px; background:none; border:1.5px solid #101622; border-radius:999px; color:#101622; font-family:inherit; font-size:13px; font-weight:700; padding:9px 18px; cursor:pointer; }
