...
TR.fr.confirmTxt='Nous avons reçu votre demande. Vous recevrez un e-mail de confirmation dans les prochaines minutes.';TR.fr.steps=['<strong>Demande reçue</strong> — nous avons vos réponses et votre profil.','<strong>Devis en chemin</strong> — nous préparons votre devis personnalisé et vous l\'envoyons par e-mail.','<strong>Rapport sur mesure</strong> — dès votre acceptation, nous commençons votre Analyse de Localisation.'];
TR.pt.confirmTxt='Recebemos a sua solicitação. Receberá um email de confirmação nos próximos minutos.';TR.pt.steps=['<strong>Solicitação recebida</strong> — temos as suas respostas e o seu perfil.','<strong>Orçamento a caminho</strong> — preparamos o seu orçamento personalizado e enviamo-lo por email.','<strong>Relatório à medida</strong> — após aceitar, iniciamos a sua Análise de Localização.'];
TR.ru.confirmTxt='Мы получили вашу заявку. В ближайшие минуты вы получите письмо с подтверждением.';TR.ru.steps=['<strong>Заявка получена</strong> — у нас есть ваши ответы и профиль.','<strong>Предложение готовится</strong> — мы подготовим персональное предложение и отправим его на email.','<strong>Отчёт под вас</strong> — после принятия мы начнём ваш Анализ локации.'];TR.en.secLabels={hi:'PRIORITY',md:'RELEVANT',lo:'STANDARD'};TR.en.motivators={6:{txt:'AREA OF INTEREST REGISTERED',sub:'We already have what we need'},10:{txt:'FINAL STRETCH',sub:'Just a few more questions'},13:{txt:'ALMOST DONE',sub:'We are preparing your profile'}};TR.en.agentTitle='I would like personalised assistance from an analyst';TR.en.agentSub='If you select this option, an analyst will contact you as soon as possible.';TR.en.blocks={1:'About you',6:'Your area of interest',8:'Your enquiry',10:'To personalise your report',13:'Your timeline'};
