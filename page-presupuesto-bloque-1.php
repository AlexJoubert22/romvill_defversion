...
var TR={
  es:{time:'Aproximadamente 4 minutos',btn:'EMPEZAMOS',
    ...
    confirmTxt:'Hemos recibido su solicitud. En 24-48 horas laborables uno de nuestros analistas revisará su caso y le enviará su presupuesto personalizado.',
    steps:['<strong>En 24-48 horas laborables</strong> revisamos su solicitud y preparamos su presupuesto.','<strong>Le enviamos su presupuesto</strong> personalizado por correo electrónico.','Si lo acepta, <strong>le enviamos el contrato</strong> y comenzamos su análisis.'],
